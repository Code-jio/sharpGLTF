...
// Read from URL.
let document = await io.read("./model/luone/luone31-1__nomerge.gltf");
...
await document.transform(
  ...
  textureCompress({ targetFormat: "webp", resize: [1024, 1024] }), // 纹理压缩 格式可选 'jpeg', 'png', 'webp', 'avif'  resize: [1024, 1024] 纹理压缩后的纹理大小
